...
BuildLlamaCppArgs() {
  ...
  # Force even distribution across local GPU + RPC workers (4 devices total)
  # Each device gets 25% of the model layers
  args+=" --split-mode layer --tensor-split 0.25,0.25,0.25,0.25"
